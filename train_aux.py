...
if __name__ == '__main__':
    ...
    #
    parser.add_argument('--data', type=str, default='data/ganggui/ganggui.yaml', help='data.yaml path')
    #
    parser.add_argument('--hyp', type=str, default='data/ganggui/hyp.ganggui.p5.yaml', help='hyperparameters path')
    #
    ...
    #
    parser.add_argument('--project', default='F:\\Data\\ganggui\\runs\\train', help='save to project/name')
